      ...
      {(clickData && (
        <div className="TempImg">
          ...
          <div>
            ...
            <img
              src={
                clickData.weather == "Clouds"
                  ? cloud
                  : clickData.weather == "Rain"
                  ? rain
                  : clickData.weather == "Clear"
                  ? clear
                  : clickData.weather == "Haze"
                  ? haze
                  : mist
              }
            />{" "}
        ...
        (sevenData && (
          <div className="TempImg">
            ...
            <div>
              ...
              <img
                src={
                  sevenData.weather == "Clouds"
                    ? cloud
                    : sevenData.weather == "Rain"
                    ? rain
                    : sevenData.weather == "Clear"
                    ? clear
                    : sevenData.weather == "Haze"
                    ? haze
                    : mist
                }
              />{" "}
